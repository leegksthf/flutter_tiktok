...
class S {
  ...
  String signUpTitle(String nameOfTheApp, DateTime when) {
    ...
    return Intl.message(
      ...
      name: 'signUpTitle',
      desc: 'The title people see when they open the app for the first item',
  ...
  /// `{value} {value, plural, =0{no comments} =1{comment} other{comments}}`
  String commentTitle(int value) {
    ...
    return Intl.message(
      '$valueString ${Intl.plural(value, zero: 'no comments', one: 'comment', other: 'comments')}',
      name: 'commentTitle',
